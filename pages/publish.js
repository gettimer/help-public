...
function Publish({ pages, publishTool, navigationData }) {
    ...
    return (
        <>
            <Head>
                <title>Publish Tool Help</title>
                <link rel='icon' href='/favicon.ico' />
                <meta name="description" content='Circleboom Publish Tool Help' />
            </Head>
            ...
            <main className={styles.wrapper}>
                <div ref={nav} className={`${styles.nav} ${isOpenNav && styles.nav_open}`}>
                    <SideMenu data={navigationData} activeItemTool={"publish"} callback={resetMenu} />
                </div>
